...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription("Aprove a suggestion. **ADMIN**")
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`This Suggesstion has been approved!`)
        ...
        interaction.reply({ content: "Suggesstion has been approved.", ephemeral: true });
    }
}